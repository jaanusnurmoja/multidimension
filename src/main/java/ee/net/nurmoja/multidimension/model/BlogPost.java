...
*/
    ...
    public String toString() {
        return "BlogPost(id=" + this.getId() + ", title=" + this.getTitle() + ", text=" + this.getText() + ", createdAt=" + this.getCreatedAt() + ", author=" + this.getAuthor() + ", blogPostSubParts=" + this.getBlogPostSubParts().size() + ")";
    }
}
